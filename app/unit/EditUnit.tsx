...
const EditUnit = ({ unit, onSuccess }: EditUnitProps) => {
  ...
  useEffect(() => {
    if (unit) {
      reset({
        ...
        business_partner_id: unit.business_partner_id,
        bedroom_count: unit.bedroom_count,
        bathroom_count: unit.bathroom_count,
        description: unit.description || "",
        is_active: unit.is_active,
        beneficiary: unit.beneficiary || "",
        remarks: unit.remarks || "",
        service_fee_percent: unit.service_fee_percent,
        profit_share_percent: unit.profit_share_percent,
      });
    }
  }, [unit, reset]);
